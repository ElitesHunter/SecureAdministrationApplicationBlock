...
namespace EnterpriseServices.SecurityService.Framework.OperationModel.Organizations
{
    ...
    public sealed class Organization : OrganizationObjectBase
    {
        ...
        static public Organization GetRoot()
        {
            ...
            DataSet dataSet = organization.ExecuteDataSet(organization.CreateCommand("Select * From Secure.OrganizationCollection Where ParentOrganizationObjectID Is NULL", CommandType.StoredProcedure));
